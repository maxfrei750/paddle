...
def inspect_model(
    ...
    :param cropping_rectangle: If not None, rectangle to use for the cropping of the validation images.
    """
    ...
    result_root = model_root / "results" / subset
    ...
    trainer = Trainer(
        ...
        gpus=-1,
        callbacks=[TestPredictionWriter(result_root)],
    )
